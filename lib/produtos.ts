...
export const produtos = [
  ...
  { id: 6, nome: "Trifásico T1", categoria: "Trifásico", categoriaTag: "T1", specs: { carga: "54.000kVA", disjuntor: "150A", cabo: "50mm², 1kV" }, inclui: ["Poste trifásico T1","Aterramento","ART"], preco: "Sob consulta", validacao: "Válido até 25km da loja", imagem: "/produtos/poste-padrao-trifasico-t1/42599f2a-5cc1-465d-b1f2-4efc0dcb76dc.png", descricao: "Poste trifásico T1..." },
  { id: 7, nome: "Trifásico T2", categoria: "Trifásico", categoriaTag: "T2", specs: { carga: "54.000kVA", disjuntor: "150A", cabo: "50mm², 1kV" }, inclui: ["Poste trifásico T2","Aterramento","ART","Pedido Elektro"], preco: "Sob consulta", validacao: "Válido até 25km da loja", imagem: "/produtos/poste-padrao-trifasico-t2/398c056c-7777-4b86-b7e3-6e2f8f4e6e2a.png", descricao: "Poste trifásico T2..." }
];
